...
<div class="container-fluid">
    ...
    <?php if ($id_fakultas > 0) { ?>
        <a href="<?php echo base_url(); ?>dashboard/tambah_laporan?id_fakultas=<?php echo $id_fakultas; ?>" class="d-none d-sm-inline-block btn btn-sm btn-info shadow-sm mb-3"><i class="fas fa-plus fa-sm text-white-50"></i> Tambah Laporan</a>
    <?php } ?>
                                ...
                                <tbody>
                                    ...
                                    foreach ($datasets as $d) { ?>
                                        <tr>
                                            ...
                                            <td><?php echo $d['pelapor']; ?> - <?php echo $d['pelapor_nama']; ?> - <?php echo $d['pelapor_nik']; ?></td>
                                            <td><?php echo $d['klasifikasi']; ?></td>
                                            <td class="exclude-export">
                                                <a class="btn btn-sm btn-info" href="<?php echo base_url(); ?>dashboard/tambah_laporan?id=<?php echo $d['id']; ?>&id_fakultas=<?php echo $id_fakultas; ?>"><i class="fa fa-pen"></i></a>
                                                <?php if ($_SESSION['role'] != 'rektor') { ?>
                                                    <a class="btn btn-sm btn-danger" href="<?php echo base_url(); ?>dashboard/delete_laporan?id=<?php echo $d['id']; ?>&id_fakultas=<?php echo $id_fakultas; ?>"><i class="fa fa-trash"></i></a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                    <?php } ?>
