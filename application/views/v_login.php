...
<head>
    ...
    <style>
        .bg-login-image {
            background: url("<?php echo base_url(); ?>assets/img/login2.png");
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <h1 class="h4 text-gray-900 mb-2" style="font-weight: 800;">Halo!</h1>
                                    <h1 class="h5 text-gray-900 mb-4">Selamat Datang di Sistem<br />E-Archive PPKS</h1>
                                    </div>
